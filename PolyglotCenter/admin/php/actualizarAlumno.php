...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $ruta_csv_profesor = "../../data/registroAlumno.csv";
    ...
    foreach ($lineas_profesor as $linea) {
        ...
        if ($datos[3] == $correo_original) {
            ...
            $linea = "$nombre,$apellido1,$apellido2,$correo_original,$telefono,$fechaNacimiento,$contrasena,$contrasena";
        }
    ...
    foreach ($lineas_tipo_usuario as $linea) {
        ...
        if ($datos[3] == $correo_original) {
            ...
            $linea = "$nombre,$apellido1,$apellido2,$correo_original,$contrasena,alumno";
        }
